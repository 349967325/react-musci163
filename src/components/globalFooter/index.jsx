      ...
      <div className={`${styles.footerContainer} clearfix`}>
        <div className={`${styles.copy}`}>
          <div className={`${styles.linksLand}`}>
            {
              footerLinks.map((item, i) => (
                <>
                  <a
                    key={`footerLinks-${i}`} href={item.link} rel='noopener noreferrer' target='_blank'
          ...
          <p className={`${styles.copyItem}`}>
            <span className={`${styles.company}`}>网易公司版权所有©1997-2021</span>
            <span>杭州乐读科技有限公司运营：浙网文[2018]3506-263号</span>
          </p>

          <p className={`${styles.copyItem}`}>
            <span className={`${styles.alert}`}>违法和不良信息举报电话：0571-89853516</span>
            <span>举报邮箱：ncm5990@163.com</span>
          </p>

          <p className={`${styles.copyItem}`}>
            <span>粤B2-20090191-18</span>
            <span className={`${styles.manageSystem}`}>工业和信息化部备案管理系统网站</span>
